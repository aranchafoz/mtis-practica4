...
stompit.connect(connectOptions, function(error, client) {
  ...
  if (error) {
    ...
    console.log('\x1b[32m', 'Office 2: Connected successfully to ActiveMQ', '\x1b[0m')
  }
...
function listenTemperatureActuator(client) {
  ...
  var subscribeHeaders = {
    'destination': '/mtis_p4/office2/temperature/actuator',
...
function listenIluminationActuator(client) {
  ...
  var subscribeHeaders = {
    'destination': '/mtis_p4/office2/illumination/actuator',
    'ack': 'client-individual'
  };
